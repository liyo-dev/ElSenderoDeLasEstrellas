...
public static partial class EldoriaCodexBuilder
{
    ...
    static void CapturarPaisaje(Camera cam)
    {
        ...
        try
        {
            ...
            informe.AppendLine("Capturas guardadas: Vista_mapa, Vista_puerto, Vista_castillo, Vista_vecino, Vista_pueblo, Vista_ruinas, Vista_jungla, Vista_bosque, Vista_ruta, Vista_hermanas, Vista_granjas, Vista_secreta, Vista_puente y Vista_valle (.png). Revisarlas antes de aceptar la composición.");
        }
        finally
        {
