...
/// <summary>
/// Controlador para la escena de dedicatoria inicial del juego.
/// Muestra dos líneas de texto con efectos de fade in/out antes de cargar el menú principal.
/// </summary>
public class DedicationController : MonoBehaviour
{
    ...
    private IEnumerator DedicationSequence()
    {
        ...
        // 6. Fade Out de ambos textos simultáneamente
        yield return StartCoroutine(FadeOutBoth(textLine1, textLine2, fadeDuration));
