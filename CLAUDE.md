...
**Toda la documentación de diseño y narrativa (historia, guión, fichas de personaje, balance de hechizos, estado de diálogos) vive en `GDD.md` — fuente de verdad única, desde el 24 ago 2026.** Sustituye al antiguo Google Doc "GDD" v1.0, que se quedó desactualizado (ejemplo: contradecía una corrección de lore de Liam ya confirmada). Antes de escribir o corregir diálogos, hechizos nuevos, o cualquier ficha de personaje, consultar `GDD.md` primero. **La novela también es canon:** al corregir historia en `GDD.md` o en `novela/manuscrito-novela-completo.md` (proyecto complementario), revisar y nivelar el otro documento si corresponde, según la regla de `GDD.md` «Sobre este documento».
