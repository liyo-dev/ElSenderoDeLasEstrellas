...
public class OliverSaludoSequencer : CinematicSequencerBase
{
    ...
    private IEnumerator Co_ApproachWill(Vector3 targetPos)
    {
        ...
        // Idle de forma explícita. SetMovementSpeed(0f) por sí solo únicamente amortigua el
        // parámetro InputMagnitude — no cambia el _currentState interno de NPCSimpleAnimator, que
        // se quedaría en Walking/Running ("andando en el sitio"). Por eso van los dos.
